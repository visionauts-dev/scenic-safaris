...
function StickyMobileCTA() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-white border-t border-gray-200 shadow-xl flex">
      <a
        href="tel:+919544968931"
        className="flex-1 flex flex-col items-center justify-center py-3 gap-0.5 text-[var(--deep-blue)] active:bg-gray-50"
      >
        <svg viewBox="0 0 24 24" className="w-5 h-5 fill-none stroke-current stroke-2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M22 16.92v3a2 2 0 01-2.18 2A19.8 19.8 0 013.07 5.18 2 2 0 015.06 3h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L9.09 10.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 17z" />
        </svg>
      ...
      <a
        ...
        className="flex-1 flex flex-col items-center justify-center py-3 gap-0.5 bg-green-500 text-white active:bg-green-600"
      >
